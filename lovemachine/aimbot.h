...
#define sensitivity 3.4f
		...
		void end()
		{
			...
			// TODO : ñäåëàé ôèêñ ëó÷øå, ÷åì viewangles.x < -87.f || viewangles.x > 87.f
			// P.S. : èñïîëüçîâàòü trace_forward äëÿ ïðîâåðêè íà âðàãà ïîä ïðèöåëîì
			// P.P.S: ïðè÷èíà - íà÷èíàåò íååñòåñòâåííî âåðòåòüñÿ
