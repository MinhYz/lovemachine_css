...
namespace legit
{
	namespace knifebot
	{
		...
		{
			// áåç áðîíè ëåâîé 20 ïðàâîé 65
			// áåç áðîíè â ñïèíó ïðàâîé 195
		...
		void end()
		{
			...
			// çàäóìêà çàêëþ÷àåòñÿ â òîì, ÷òîáû òðåéñèòü ïî íåñêîëüêî ëó÷åé âëåâî è âïðàâî, òàêèì îáðàçîì íàõîäÿ áëèæàéøåãî ê íàì
			// +òàê ëó÷øå ðàññ÷èòûâàåòñÿ äèñòàíöèÿ äî èãðîêà
			for (int i = 0; i < 5; i++)
				for (int j = 0; j < 3; j++)
				{
