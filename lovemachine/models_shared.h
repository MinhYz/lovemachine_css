...
namespace ModelMgr
{
	inline std::vector<CustomModelEntry> model_entries = {
		...
		{ "Arctic (T)", "models/player/t_arctic.mdl" },
		{ "Guerilla (T)", "models/player/t_guerilla.mdl" },
		{ "Urban / Seal (CT)", "models/player/ct_urban.mdl" },
		{ "GSG-9 (CT)", "models/player/ct_gsg9.mdl" },
		{ "SAS (CT)", "models/player/ct_sas.mdl" },
		{ "GIGN (CT)", "models/player/ct_gign.mdl" },
		{ "Hostage 01", "models/characters/hostage_01.mdl" },
		{ "Hostage 02", "models/characters/hostage_02.mdl" },
		{ "Hostage 03", "models/characters/hostage_03.mdl" },
		{ "Hostage 04", "models/characters/hostage_04.mdl" },
