	...
	bool is_armored(int hitgroup)
	{
		if (get_armor() > 0)
		{
			...
			case hg_rightarm:
				...
				break;
			case hg_head:
				// TODO: íàéòè êàê îïðåäåëèòü íàëè÷èå øëåìàêà
...
public:
	...
	// TODO: ïåðåðàáîòàòü âñå ýòè is_%weapon_name% â îäèí get_type, à ëó÷øå íàéòè vfunc
	//
	//õç ÷òî ñ íàçâàíèåì, íî êàæäûé ðàç â íà÷àëå íåïîíÿòíûå ñèìâîëû (2-6 øòóê)
	// q??weapon_%name%
	...
	// ïîñêîëüêó wpndata åáíóòàÿ áóäåò òàê
	int get_maxclip1()
	{
